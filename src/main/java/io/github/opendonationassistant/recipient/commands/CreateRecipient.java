...
public class CreateRecipient {
  ...
  public HttpResponse<CreateRecipientCommandResponse> createRecipient(
    ...
    Optional.ofNullable(command.email()).ifPresent(newUser::setEmail);
    var password = Optional.ofNullable(command.password()).orElseGet(
      this::generateCommonLangPassword
    );
  ...
  @Serdeable
  public static record CreateRecipientCommand(
    String nickname,
